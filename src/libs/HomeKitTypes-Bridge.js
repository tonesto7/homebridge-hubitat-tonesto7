...
Characteristic.AppMatchingIdentifier.UUID =
  "000000A4-0000-1000-8000-0026BB765291";
...
Characteristic.ProgrammableSwitchOutputState.UUID =
  "00000074-0000-1000-8000-0026BB765291";
...
Service.CameraControl = function (displayName, subtype) {
  Service.call(
    this,
    displayName,
    "00000111-0000-1000-8000-0026BB765291",
    subtype,
  );
...
Service.StatefulProgrammableSwitch.UUID =
  "00000088-0000-1000-8000-0026BB765291";

// Aliases
Characteristic.SelectedStreamConfiguration =
...
Characteristic.AccessoryIdentifier.UUID =
  "00000057-0000-1000-8000-0026BB765291";
...
Characteristic.ConfigureBridgedAccessory = function () {
  Characteristic.call(
    ...
    "000000A0-0000-1000-8000-0026BB765291",
  );
  this.setProps({
    format: Characteristic.Formats.TLV8,
...
Characteristic.ConfigureBridgedAccessory.UUID =
  "000000A0-0000-1000-8000-0026BB765291";
...
Characteristic.ConfigureBridgedAccessoryStatus = function () {
  Characteristic.call(
    ...
    "0000009D-0000-1000-8000-0026BB765291",
  );
  this.setProps({
    format: Characteristic.Formats.TLV8,
    perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY],
...
Characteristic.ConfigureBridgedAccessoryStatus.UUID =
  "0000009D-0000-1000-8000-0026BB765291";
...
Characteristic.DiscoverBridgedAccessories.UUID =
  "0000009E-0000-1000-8000-0026BB765291";
...
Characteristic.DiscoveredBridgedAccessories = function () {
  Characteristic.call(
    ...
    "0000009F-0000-1000-8000-0026BB765291",
  );
  this.setProps({
    format: Characteristic.Formats.UINT16,
    perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY],
...
Characteristic.DiscoveredBridgedAccessories.UUID =
  "0000009F-0000-1000-8000-0026BB765291";
...
Characteristic.LinkQuality = function () {
  Characteristic.call(
    this,
    "Link Quality",
    "0000009C-0000-1000-8000-0026BB765291",
  );
  this.setProps({
    format: Characteristic.Formats.UINT8,
    maxValue: 4,
...
Characteristic.Reachable = function () {
  Characteristic.call(
    this,
    "Reachable",
    "00000063-0000-1000-8000-0026BB765291",
  );
  this.setProps({
...
Characteristic.RelayControlPoint = function () {
  Characteristic.call(
    this,
    "Relay Control Point",
    "0000005E-0000-1000-8000-0026BB765291",
  );
  this.setProps({
    format: Characteristic.Formats.TLV8,
    perms: [
...
Characteristic.RelayEnabled = function () {
  Characteristic.call(
    this,
    "Relay Enabled",
    "0000005B-0000-1000-8000-0026BB765291",
  );
  this.setProps({
    format: Characteristic.Formats.BOOL,
    perms: [
...
Characteristic.RelayState = function () {
  Characteristic.call(
    this,
    "Relay State",
    "0000005C-0000-1000-8000-0026BB765291",
  );
  this.setProps({
    format: Characteristic.Formats.UINT8,
    perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY],
...
Characteristic.TunnelConnectionTimeout = function () {
  Characteristic.call(
    ...
    "00000061-0000-1000-8000-0026BB765291",
  );
  this.setProps({
...
Characteristic.TunnelConnectionTimeout.UUID =
  "00000061-0000-1000-8000-0026BB765291";
...
Characteristic.TunneledAccessoryAdvertising = function () {
  Characteristic.call(
    ...
    "00000060-0000-1000-8000-0026BB765291",
  );
  this.setProps({
    format: Characteristic.Formats.BOOL,
    perms: [
...
Characteristic.TunneledAccessoryAdvertising.UUID =
  "00000060-0000-1000-8000-0026BB765291";
...
Characteristic.TunneledAccessoryConnected = function () {
  Characteristic.call(
    ...
    "00000059-0000-1000-8000-0026BB765291",
  );
  this.setProps({
    format: Characteristic.Formats.BOOL,
    perms: [
...
Characteristic.TunneledAccessoryConnected.UUID =
  "00000059-0000-1000-8000-0026BB765291";
...
Characteristic.TunneledAccessoryStateNumber = function () {
  Characteristic.call(
    ...
    "00000058-0000-1000-8000-0026BB765291",
  );
  this.setProps({
...
Characteristic.TunneledAccessoryStateNumber.UUID =
  "00000058-0000-1000-8000-0026BB765291";
...
Service.BridgeConfiguration = function (displayName, subtype) {
  Service.call(
    this,
    displayName,
    "000000A1-0000-1000-8000-0026BB765291",
    subtype,
  );
...
Service.BridgingState = function (displayName, subtype) {
  Service.call(
    this,
    displayName,
    "00000062-0000-1000-8000-0026BB765291",
    subtype,
  );
...
Service.Relay = function (displayName, subtype) {
  Service.call(
    this,
    displayName,
    "0000005A-0000-1000-8000-0026BB765291",
    subtype,
  );
...
Service.TunneledBTLEAccessoryService = function (displayName, subtype) {
  Service.call(
    this,
    displayName,
    "00000056-0000-1000-8000-0026BB765291",
    subtype,
  );
...
Service.TunneledBTLEAccessoryService.UUID =
  "00000056-0000-1000-8000-0026BB765291";
