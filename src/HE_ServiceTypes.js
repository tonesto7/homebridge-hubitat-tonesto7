...
const serviceTests = [
    new ServiceTest(
        "window_shade",
        (accessory) =>
        (accessory.hasCapability("Window Shade") || accessory.hasCapability("WindowShade")) &&
        !(
    ...
    new ServiceTest("fan", (accessory) => accessory.hasCapability("FanControl")),
    ...
    new ServiceTest("light", (accessory) => accessory.hasCapability("Switch") && (accessory.hasCapability("LightBulb") || accessory.hasCapability("Light") || accessory.hasCapability("Fan Light") || accessory.hasCapability("Bulb") || accessory.context.deviceData.name.toLowerCase().includes("light") || accessory.hasAttribute("saturation") || accessory.hasAttribute("hue") || accessory.hasAttribute("colorTemperature") || accessory.hasCapability("Color Control"))),
    new ServiceTest("switch_device", (accessory) => accessory.hasCapability("Switch") && !(accessory.hasCapability("LightBulb") || accessory.hasCapability("Light") || accessory.hasCapability("Fan Light") || accessory.hasCapability("Bulb") || accessory.context.deviceData.name.toLowerCase().includes("light") || accessory.hasCapability("Button")), true),
